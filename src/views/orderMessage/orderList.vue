    ...
    <div>
        ...
        <el-card class="box-card">
            <el-row :gutter="20">
                ...
                <el-col :span="3"
                    ><div class="grid-content bg-purple">
                        <el-button type="primary" size="medium">搜索订单</el-button>
                    </div></el-col
                >
            </el-row>
            <!-- 用户列表 -->
            <el-table :data="orderList" stripe style="width: 100%">
                ...
                <el-table-column prop="order_number" min-width="200" label="订单编号">
                </el-table-column>
                <el-table-column prop="order_price" label="订单价格" >
                </el-table-column>
                <el-table-column prop="pay_status" label="是否付款"> </el-table-column>
                <el-table-column prop="is_send" width="80" label="是否发货"> </el-table-column>
                <el-table-column prop="pay_status" label="地址"> </el-table-column>
                <el-table-column prop="create_time" min-width="200" label="下单时间">
